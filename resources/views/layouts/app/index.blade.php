...
<body>
    ...
    <main id="main">
        <div class="autocomplete-app">
            ...
            <div class="container autocomplete-div mt-3">
        ...
        <div class="map-section container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <button class="btn btn-danger container mt-3" id="btn-show-routes">
                        <i class="fas fa-location-arrow"></i>
                    </button>
                </div>
            </div>
    ...
    @include('layouts.app.partials.autocomplete')
    @include('layouts.app.partials.scanner')
